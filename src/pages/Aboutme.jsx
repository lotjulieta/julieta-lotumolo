...
export default function Aboutme() {
  return(
    <div className="flex justify-center items-center h-screen">
      <section className="sm:w-3/4 lg:w-3/4 px-4 md:mt-0">
          ...
          <div className="lg:flex lg:items-center">
            ...
            <div className="lg:w-1/2">
              ...
              <p className="text-lg lg:text-xl leading-relaxed text-center">
                I´m a passionate Backend Developer with experience in Python and Javascript. I´ve worked in web development, AI development, robotics and automation. I specialize in web design, data modeling, and programming. I´m great at effectively leading teams and fostering proactivity in the workplace.
              </p>
