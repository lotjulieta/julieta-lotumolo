  ...
  return (
   <div className="container mx-auto my-22 flex items-start">
      <div className="w-full md:w-1/2">
        <img src="src\images\cute-robot-waving-hand-cartoon-icon-illustration-science-technology-icon-concept-isolated-premium-flat-cartoon-style-vector-Photoroom.png-Photoroom.png" alt="Contact" className="h-auto w-full animate-bounce" style={{ marginTop: '230px', marginLeft: '-100px' }} />
      </div>
      <div className="w-full md:w-1/2">
        <h1 className="text-4xl text-center mb-10 mt-10" style={{ marginLeft: '-460px' }}>Contact me!</h1>
