    ...
    <section className="bg-zinc-950 text-white py-10 lg:py-10 md:mt-12 md:mr-12 sm:mt-14">
      <div className="container mx-auto flex flex-col lg:flex-row items-center justify-center">
        <div className="lg:w-2/3">
          ...
          <p className="animate__animated animate__bounceInLeft text-xl lg:text-3xl leading-relaxed text-center lg:text-left" style={{ color: '#6C63FF'}}>I´m a Backend Developer.</p>
